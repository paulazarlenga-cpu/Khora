...
export default function StorePage() {
  ...
  async function addToCart(product: Product, quantity = 1) {
    ...
    try { await syncReservation(next); setNotice(`${product.name} quedó reservado en tu carrito.`); setBagAnimation((value) => value + 1); return true; } catch { /* message already visible */ return false; }
  }
...
function StoreHeader({ cartCount, filled, animationTrigger, query, onHome, onCatalog, onStory, onCart, onQueryChange }: StoreHeaderProps) {
