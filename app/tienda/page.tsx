...
export default function StorePage() {
  ...
  return <div className={styles.storeShell}>
    ...
    {view === "aroma" && <AromaFinder products={products} options={sensoryOptions} saving={saving} onBack={() => navigate("home")} onOpenProduct={(id) => navigate("product", id)} onAddProduct={async (id) => { const product = products.find((item) => item.id === id); return product ? addToCart(product) : false; }} />}
