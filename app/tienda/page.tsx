...
type Product = { id: number; code: string; name: string; description: string; category: string; type: string; priceCents: number; stock: number; availableStock: number; imagePath: string | null; published: boolean; unitsSold?: number; collectionMemberships: Array<{ collectionId: number; sortOrder: number }> };
...
function StoreHeader({ cartCount, filled, query, onHome, onCatalog, onStory, onCart, onQueryChange }: StoreHeaderProps) {
