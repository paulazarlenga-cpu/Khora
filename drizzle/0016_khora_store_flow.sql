...
ALTER TABLE products ADD COLUMN IF NOT EXISTS store_published INTEGER NOT NULL DEFAULT 1 CHECK(store_published IN (0,1));
ALTER TABLE clients ADD COLUMN IF NOT EXISTS store_phone_normalized TEXT;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS store_source TEXT NOT NULL DEFAULT 'ADMIN';
ALTER TABLE orders ADD COLUMN IF NOT EXISTS store_idempotency_key TEXT;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS store_reservation_id INTEGER;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS store_stock_committed_at TEXT;
